	...
	public ReporteVenta() {
		...
		btnGenerarReporte.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!textField_dia.getText().isEmpty() && !textField_mes.getText().isEmpty() && !textField_año.getText().isEmpty()) {
				...
				columnNames.add("Codigo Venta");
				columnNames.add("Numero Caja");
				columnNames.add("Nombre Cajero");
				columnNames.add("Importe Total");
				columnNames.add("Importe Recibido");
				columnNames.add("Vuelto");

				// Pedir los datos al supermercado

				Vector<Vector<String>> datos = Supermercado.getInstancia().consultarVentaFiltroVenta(fechaVenta, numeroCaja,
						nombreCajero);

				JScrollPane scrollPane = new JScrollPane();
				scrollPane.setBounds(35, 202, 692, 301);
		...
		JLabel lblFiltros = new JLabel("Filtros para la generacion de reporte - Filtros combinados");
		lblFiltros.setBounds(375, 24, 300, 14);
